...
CONSTRAINT PK_CADASTRO_DB_Email_Id primary key clustered (Email, id)
)

insert into CADASTRO_DB(Email,Telefone,Nome,endereco,num_endereco,complemento,senha)
values(
'Teste@testemail.com.br','11932427543','Teste da silva junior','Rua das campinas','35','B','Testedesenha123'
)
